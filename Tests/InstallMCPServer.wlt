...
VerificationTest[
    ...
    _File,
    SameTest -> MatchQ,
    TestID   -> "InstallLocation-Junie-Windows@@Tests/InstallMCPServer.wlt:1852,1-1857,2"
]
...
VerificationTest[
    ...
    _File,
    SameTest -> MatchQ,
    TestID   -> "InstallLocation-Junie-MacOSX@@Tests/InstallMCPServer.wlt:1859,1-1864,2"
]
...
VerificationTest[
    ...
    _File,
    SameTest -> MatchQ,
    TestID   -> "InstallLocation-Junie-Unix@@Tests/InstallMCPServer.wlt:1866,1-1871,2"
]
...
VerificationTest[
    ...
    "Junie",
    SameTest -> Equal,
    TestID   -> "InstallDisplayName-Junie@@Tests/InstallMCPServer.wlt:1873,1-1878,2"
]
...
VerificationTest[
    ...
    "Junie",
    SameTest -> Equal,
    TestID   -> "ToInstallName-Junie@@Tests/InstallMCPServer.wlt:1880,1-1885,2"
]
...
VerificationTest[
    Module[ { path, result },
        path = FileNameJoin @ { $TemporaryDirectory, "TestProject" };
        result = Wolfram`AgentTools`Common`projectInstallLocation[ "Junie", path ];
        FileNameTake[ First @ result, -3 ]
    ],
    FileNameJoin @ { ".junie", "mcp", "mcp.json" },
    SameTest -> Equal,
    TestID   -> "ProjectInstallLocation-Junie@@Tests/InstallMCPServer.wlt:1890,1-1899,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "InstallMCPServer-Junie-Basic@@Tests/InstallMCPServer.wlt:1904,1-1910,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "InstallMCPServer-Junie-FileExists@@Tests/InstallMCPServer.wlt:1912,1-1917,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "InstallMCPServer-Junie-VerifyContent@@Tests/InstallMCPServer.wlt:1919,1-1927,2"
]
...
VerificationTest[
    Module[ { content, server },
        content = Import[ junieConfigFile, "RawJSON" ];
        server = content[ "mcpServers", "Wolfram" ];
        Sort @ Select[ Keys @ server, MemberQ[ { "disabled", "autoApprove", "alwaysAllow", "tools" }, # ] & ]
    ],
    { },
    SameTest -> Equal,
    TestID   -> "InstallMCPServer-Junie-NoClientDecoration@@Tests/InstallMCPServer.wlt:1929,1-1938,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "UninstallMCPServer-Junie-Basic@@Tests/InstallMCPServer.wlt:1940,1-1945,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "UninstallMCPServer-Junie-VerifyRemoval@@Tests/InstallMCPServer.wlt:1947,1-1955,2"
]
...
VerificationTest[
    ...
    { Null },
    SameTest -> MatchQ,
    TestID   -> "InstallMCPServer-Junie-Cleanup@@Tests/InstallMCPServer.wlt:1957,1-1962,2"
]

(* ::**************************************************************************************************************:: *)
(* ::Subsection::Closed:: *)
(*Junie Preserves Existing Config*)
VerificationTest[
    junieConfigFile = testConfigFile[];
    Export[ junieConfigFile, <| "customSetting" -> True, "mcpServers" -> <| |> |>, "JSON" ];
    installResult = InstallMCPServer[ junieConfigFile, "WolframLanguage", "VerifyLLMKit" -> False, "ApplicationName" -> "Junie" ],
    _Success,
    SameTest -> MatchQ,
    TestID   -> "InstallMCPServer-Junie-PreserveExisting@@Tests/InstallMCPServer.wlt:1967,1-1974,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "InstallMCPServer-Junie-VerifyPreserved@@Tests/InstallMCPServer.wlt:1976,1-1985,2"
]
...
VerificationTest[
    ...
    { Null },
    SameTest -> MatchQ,
    TestID   -> "InstallMCPServer-Junie-PreserveExisting-Cleanup@@Tests/InstallMCPServer.wlt:1987,1-1992,2"
]
...
VerificationTest[
    ...
    SameTest -> MatchQ,
    TestID   -> "SupportedMCPClients-ReturnsAssociation@@Tests/InstallMCPServer.wlt:1999,1-2004,2"
]
...
VerificationTest[
    ...
    15,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-Has15Clients@@Tests/InstallMCPServer.wlt:2006,1-2011,2"
]

VerificationTest[
    Keys @ $SupportedMCPClients,
    { "Antigravity", "ClaudeCode", "ClaudeDesktop", "Cline", "Codex", "CopilotCLI", "Cursor", "GeminiCLI", "Goose", "Junie", "Kiro", "OpenCode", "VisualStudioCode", "Windsurf", "Zed" },
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-KeysSorted@@Tests/InstallMCPServer.wlt:2013,1-2018,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-AllHaveRequiredKeys@@Tests/InstallMCPServer.wlt:2020,1-2037,2"
]
...
VerificationTest[
    ...
    "Claude Desktop",
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-ClaudeDesktopDisplayName@@Tests/InstallMCPServer.wlt:2039,1-2044,2"
]
...
VerificationTest[
    ...
    { "Claude" },
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-ClaudeDesktopAliases@@Tests/InstallMCPServer.wlt:2046,1-2051,2"
]
...
VerificationTest[
    ...
    "TOML",
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-CodexConfigFormat@@Tests/InstallMCPServer.wlt:2053,1-2058,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-CodexProjectSupport@@Tests/InstallMCPServer.wlt:2060,1-2065,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-ClaudeCodeProjectSupport@@Tests/InstallMCPServer.wlt:2067,1-2072,2"
]
...
VerificationTest[
    ...
    { "context_servers" },
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-ZedConfigKey@@Tests/InstallMCPServer.wlt:2074,1-2079,2"
]
...
VerificationTest[
    ...
    { "servers" },
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-VSCodeConfigKey@@Tests/InstallMCPServer.wlt:2081,1-2086,2"
]
...
VerificationTest[
    ...
    { "mcp" },
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-OpenCodeConfigKey@@Tests/InstallMCPServer.wlt:2088,1-2093,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-AllHaveValidURLs@@Tests/InstallMCPServer.wlt:2095,1-2100,2"
]
...
VerificationTest[
    ...
    "Zed",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-Zed@@Tests/InstallMCPServer.wlt:2130,1-2140,2"
]
...
VerificationTest[
    ...
    "VisualStudioCode",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-VisualStudioCode-Legacy@@Tests/InstallMCPServer.wlt:2143,1-2153,2"
]
...
VerificationTest[
    ...
    "VisualStudioCode",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-VisualStudioCode@@Tests/InstallMCPServer.wlt:2156,1-2167,2"
]
...
VerificationTest[
    ...
    None,
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-GenericServersKey@@Tests/InstallMCPServer.wlt:2170,1-2180,2"
]
...
VerificationTest[
    ...
    "OpenCode",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-OpenCode@@Tests/InstallMCPServer.wlt:2183,1-2193,2"
]
...
VerificationTest[
    ...
    "CopilotCLI",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-CopilotCLI@@Tests/InstallMCPServer.wlt:2196,1-2206,2"
]
...
VerificationTest[
    ...
    "Cline",
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-Cline@@Tests/InstallMCPServer.wlt:2209,1-2219,2"
]
...
VerificationTest[
    ...
    None,
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-Ambiguous@@Tests/InstallMCPServer.wlt:2222,1-2232,2"
]
...
VerificationTest[
    ...
    None,
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-EmptyJSON@@Tests/InstallMCPServer.wlt:2235,1-2245,2"
]
...
VerificationTest[
    ...
    None,
    SameTest -> Equal,
    TestID   -> "GuessClientNameFromJSON-NonExistentFile@@Tests/InstallMCPServer.wlt:2248,1-2254,2"
]
...
VerificationTest[
    ...
    { "mcpServers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-ClaudeDesktop@@Tests/InstallMCPServer.wlt:2259,1-2266,2"
]
...
VerificationTest[
    ...
    { "servers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-VSCode@@Tests/InstallMCPServer.wlt:2268,1-2275,2"
]
...
VerificationTest[
    ...
    { "servers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-VSCode-MCPJson@@Tests/InstallMCPServer.wlt:2278,1-2286,2"
]
...
VerificationTest[
    ...
    { "mcp", "servers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-VSCode-LegacySettings@@Tests/InstallMCPServer.wlt:2289,1-2297,2"
]
...
VerificationTest[
    ...
    { "context_servers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-Zed@@Tests/InstallMCPServer.wlt:2299,1-2306,2"
]
...
VerificationTest[
    ...
    { "mcp" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-OpenCode@@Tests/InstallMCPServer.wlt:2308,1-2315,2"
]
...
VerificationTest[
    ...
    { "mcpServers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-UnknownFallback@@Tests/InstallMCPServer.wlt:2317,1-2322,2"
]
...
VerificationTest[
    ...
    { "mcpServers" },
    SameTest -> Equal,
    TestID   -> "ConfigKeyPath-NoneFallback@@Tests/InstallMCPServer.wlt:2324,1-2331,2"
]
...
VerificationTest[
    ...
    <| "mcpServers" -> <| |> |>,
    SameTest -> Equal,
    TestID   -> "EmptyConfigForPath-SingleKey@@Tests/InstallMCPServer.wlt:2336,1-2341,2"
]
...
VerificationTest[
    ...
    <| "mcp" -> <| "servers" -> <| |> |> |>,
    SameTest -> Equal,
    TestID   -> "EmptyConfigForPath-NestedKeys@@Tests/InstallMCPServer.wlt:2343,1-2348,2"
]
...
VerificationTest[
    ...
    <| |>,
    SameTest -> Equal,
    TestID   -> "EmptyConfigForPath-EmptyPath@@Tests/InstallMCPServer.wlt:2350,1-2355,2"
]
...
VerificationTest[
    ...
    <| "other" -> 1, "mcpServers" -> <| |> |>,
    SameTest -> Equal,
    TestID   -> "EnsureNestedKey-AddMissing@@Tests/InstallMCPServer.wlt:2360,1-2365,2"
]
...
VerificationTest[
    ...
    <| "mcpServers" -> <| "existing" -> "data" |> |>,
    SameTest -> Equal,
    TestID   -> "EnsureNestedKey-PreserveExisting@@Tests/InstallMCPServer.wlt:2367,1-2375,2"
]
...
VerificationTest[
    ...
    SameTest -> Equal,
    TestID   -> "EnsureNestedKey-DeepNesting@@Tests/InstallMCPServer.wlt:2377,1-2385,2"
]
...
VerificationTest[
    ...
    SameTest -> Equal,
    TestID   -> "EnsureNestedKey-PartiallyExisting@@Tests/InstallMCPServer.wlt:2387,1-2395,2"
]
...
VerificationTest[
    ...
    <| "mcpServers" -> <| |> |>,
    SameTest -> Equal,
    TestID   -> "EnsureNestedKey-NonAssocInput@@Tests/InstallMCPServer.wlt:2397,1-2402,2"
]
...
VerificationTest[
    ...
    SameTest -> SameQ,
    TestID   -> "ServerConverter-OpenCode@@Tests/InstallMCPServer.wlt:2407,1-2412,2"
]
...
VerificationTest[
    ...
    Wolfram`AgentTools`SupportedClients`Private`convertToCopilotCLIFormat,
    SameTest -> SameQ,
    TestID   -> "ServerConverter-CopilotCLI@@Tests/InstallMCPServer.wlt:2414,1-2419,2"
]
...
VerificationTest[
    ...
    Wolfram`AgentTools`SupportedClients`Private`convertToClineFormat,
    SameTest -> SameQ,
    TestID   -> "ServerConverter-Cline@@Tests/InstallMCPServer.wlt:2421,1-2426,2"
]

VerificationTest[
    Wolfram`AgentTools`InstallMCPServer`Private`serverConverter[ "Junie" ],
    Identity,
    SameTest -> SameQ,
    TestID   -> "ServerConverter-Junie-Identity@@Tests/InstallMCPServer.wlt:2428,1-2433,2"
]
...
VerificationTest[
    ...
    Identity,
    SameTest -> SameQ,
    TestID   -> "ServerConverter-Default@@Tests/InstallMCPServer.wlt:2435,1-2440,2"
]
...
VerificationTest[
    ...
    "Wolfram",
    SameTest -> Equal,
    TestID   -> "ResolveMCPServerName-BuiltInServer@@Tests/InstallMCPServer.wlt:2445,1-2452,2"
]
...
VerificationTest[
    ...
    "CustomKey",
    SameTest -> Equal,
    TestID   -> "ResolveMCPServerName-OptionOverride@@Tests/InstallMCPServer.wlt:2454,1-2461,2"
]
...
VerificationTest[
    ...
    "Wolfram",
    SameTest -> Equal,
    TestID   -> "ResolveMCPServerName-WolframServer@@Tests/InstallMCPServer.wlt:2463,1-2470,2"
]
...
VerificationTest[
    ...
    "MockMCPPacletTest",
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-MockPacletSetup@@Tests/InstallMCPServer.wlt:2486,1-2493,2"
]
...
VerificationTest[
    ...
    "TestServer",
    SameTest -> Equal,
    TestID   -> "MCPServerName-PacletServerProperty@@Tests/InstallMCPServer.wlt:2498,1-2503,2"
]
...
VerificationTest[
    ...
    "TestServer",
    SameTest -> Equal,
    TestID   -> "ResolveMCPServerName-PacletServerShortName@@Tests/InstallMCPServer.wlt:2508,1-2515,2"
]
...
VerificationTest[
    ...
    _PacletObject,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-EnsurePacletAlreadyInstalled@@Tests/InstallMCPServer.wlt:2520,1-2525,2"
]
...
VerificationTest[
    ...
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-EnsurePacletThreeSegment@@Tests/InstallMCPServer.wlt:2530,1-2537,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-Install@@Tests/InstallMCPServer.wlt:2542,1-2548,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "InstallPacletServer-ConfigFileExists@@Tests/InstallMCPServer.wlt:2553,1-2558,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "InstallPacletServer-ConfigHasServerName@@Tests/InstallMCPServer.wlt:2563,1-2569,2"
]
...
VerificationTest[
    ...
    SameTest -> Equal,
    TestID   -> "InstallPacletServer-ConfigEnvServerName@@Tests/InstallMCPServer.wlt:2574,1-2579,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-Uninstall@@Tests/InstallMCPServer.wlt:2584,1-2589,2"
]
...
VerificationTest[
    ...
    False,
    SameTest -> Equal,
    TestID   -> "InstallPacletServer-VerifyUninstall@@Tests/InstallMCPServer.wlt:2594,1-2600,2"
]
...
VerificationTest[
    ...
    _MCPServerObject? MCPServerObjectQ,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-ResultHasMCPServerObject@@Tests/InstallMCPServer.wlt:2605,1-2611,2"
]
...
VerificationTest[
    ...
    Null,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-ValidateDefinitionsValid@@Tests/InstallMCPServer.wlt:2616,1-2622,2"
]
...
VerificationTest[
    ...
    Null,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-ValidateDefinitionsNoOp@@Tests/InstallMCPServer.wlt:2627,1-2638,2"
]
...
VerificationTest[
    ...
    { AgentTools::PacletNotInstalled },
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-ValidateToolError@@Tests/InstallMCPServer.wlt:2643,1-2658,2"
]
...
VerificationTest[
    ...
    { AgentTools::PacletNotInstalled },
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-ValidatePromptError@@Tests/InstallMCPServer.wlt:2663,1-2678,2"
]
...
VerificationTest[
    ...
    <| |>,
    SameTest -> MatchQ,
    TestID   -> "InstallPacletServer-Cleanup@@Tests/InstallMCPServer.wlt:2683,1-2689,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-BuiltInUsesWolframKey-Install@@Tests/InstallMCPServer.wlt:2700,1-2706,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-BuiltInUsesWolframKey-Verify@@Tests/InstallMCPServer.wlt:2708,1-2715,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-SecondBuiltInOverwrites-Install@@Tests/InstallMCPServer.wlt:2720,1-2725,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-SecondBuiltInOverwrites-Verify@@Tests/InstallMCPServer.wlt:2727,1-2734,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-UninstallBuiltIn@@Tests/InstallMCPServer.wlt:2739,1-2744,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-UninstallBuiltIn-Verify@@Tests/InstallMCPServer.wlt:2746,1-2752,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-CustomServerUsesName-Install@@Tests/InstallMCPServer.wlt:2757,1-2767,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-CustomServerUsesName-Verify@@Tests/InstallMCPServer.wlt:2769,1-2775,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-OptionOverride-Install@@Tests/InstallMCPServer.wlt:2780,1-2785,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-OptionOverride-Verify@@Tests/InstallMCPServer.wlt:2787,1-2793,2"
]
...
VerificationTest[
    ...
    _Success,
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-TwoBuiltInWithOverrides-Install@@Tests/InstallMCPServer.wlt:2798,1-2805,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-TwoBuiltInWithOverrides-Verify@@Tests/InstallMCPServer.wlt:2807,1-2814,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-StaleRecordClearing-Setup@@Tests/InstallMCPServer.wlt:2819,1-2827,2"
]
...
VerificationTest[
    ...
    True,
    SameTest -> Equal,
    TestID   -> "MCPServerName-StaleRecordClearing-Verify@@Tests/InstallMCPServer.wlt:2829,1-2839,2"
]
...
VerificationTest[
    ...
    { Null.. },
    SameTest -> MatchQ,
    TestID   -> "MCPServerName-Cleanup@@Tests/InstallMCPServer.wlt:2844,1-2853,2"
]
